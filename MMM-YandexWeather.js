...
Module.register('MMM-YandexWeather', {
  ...
  getDom() {
    ...
    if (this.config.showHourlyForecast && this.hourlyData && this.hourlyData.hours && this.hourlyData.hours.edges) {
  ...
  renderHourlyForecast() {
    ...
    for (let i = 0; i < this.hourlyData.hours.edges.length; i++) {
      const hour = this.hourlyData.hours.edges[i].node
